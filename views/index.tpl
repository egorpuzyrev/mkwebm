<html>
    ...
    <body>
        ...
        <p>Готовые файлы хранятся сутки.</p>
        <p>Конвертация - процесс небыстрый. Редирект на готовый файл происходит автоматически, нужно только подождать.</p>
        <p>Гифки <s>временно не поддерживаются.</s> </p>
